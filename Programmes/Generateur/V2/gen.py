...
import os
import sys
print("WARNING /!\ ce script prend en entree une image servant de 'map', ou un labyrinthe incomplet, il doit y avoir au moins une case blanche ou grise au départ et si on veut restreindre le programme a un template, faut mettre des limites en bleu")
...
def ckoa(pix):     #reconaissance de mur/chemin/end/start
        ...
        for k in cu2:                    #On fait "pousser" "l'arbre" de la sortie.
            ...
            if possible(g,i,j,p,q) and randint(0,PROB)==1:
                ...
                if possible(g,i,j,p,q):
                    nxt2.append((i,j))
    l=[]
    print("Les deux 'arbres' ont fini de 'pousser'.")
...
genere("40 par 40",40,40,0,0,39,39)
print(time.time()-t0)
